import { Object3D, Scene, WebGLRenderer, Box3, Geometry, Vector3, Mesh, Face3, MeshBasicMaterial, Vector2, Raycaster, PerspectiveCamera, Group, LineSegments, LineBasicMaterial, Plane, PlaneGeometry, BackSide, FrontSide, BoxGeometry, ShaderMaterial } from 'three';
...
class BoxFace extends Mesh {
    ...
    constructor(axis: string, vertices: Array<Vector3>) {
        ...
        this.geometry = new Geometry();
        this.geometry.vertices.push(...vertices);
        this.geometry.faces.push(new Face3(0, 3, 2), new Face3(0, 2, 1));
